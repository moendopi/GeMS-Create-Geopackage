...
GeMS_basic_feature_class_fields = {
    ...
    "ContactsAndFaults": (
        ...
        Field('LocationConfidenceMeters', SQLFieldTypes.text),
    ...
    "DescriptionOfMapUnits": (
        ...
        Field('DescriptionOfMapUnits_ID', SQLFieldTypes.text, 50),
    ),
    ...
    "GenericPoints": (
        ...
        Field('Label', SQLFieldTypes.text, 50),
        Field('LocationConfidenceMeters', SQLFieldTypes.text),
        Field('PlotAtScale', SQLFieldTypes.text),
    ...
    "OrientationPoints": (
        Field('Type', SQLFieldTypes.text, 254),
        Field('Azimuth', SQLFieldTypes.text),
        Field('Inclination', SQLFieldTypes.text),
        Field('Symbol', SQLFieldTypes.text, 254),
        Field('Label', SQLFieldTypes.text, 50),
        Field('LocationConfidenceMeters', SQLFieldTypes.text),
        Field('IdentityConfidence', SQLFieldTypes.text, 50),
        Field('OrientationConfidenceDegrees', SQLFieldTypes.text),
        Field('PlotAtScale', SQLFieldTypes.text),
        Field('StationID', SQLFieldTypes.text, 50),
        Field('MapUnit', SQLFieldTypes.text, 10),
        Field('LocationSourceID', SQLFieldTypes.text, 50),
    ...
    "OrientationLines": (
        ...
        Field('OrientationSourceID', SQLFieldTypes.text, 50),
        Field('Notes', SQLFieldTypes.text, 254),
        Field('OrientationLines_ID', SQLFieldTypes.text, 50),
    ),
    ...
    "GeochronPoints": (
        ...
        Field('NumericAge', SQLFieldTypes.text), 
        Field('AgePlusError', SQLFieldTypes.text),
        Field('AgeMinusError', SQLFieldTypes.text),
    ...
    "Stations": (
        ...
        Field('SignificantDimensionMeters', SQLFieldTypes.text),
    ...
    "IsoValueLines": (
        Field('Type', SQLFieldTypes.text, 254),
        Field('Value', SQLFieldTypes.text),
        Field('ValueConfidence', SQLFieldTypes.text),
        Field('Symbol', SQLFieldTypes.text, 254),
        Field('Label', SQLFieldTypes.text, 50),
        Field('DataSourceID', SQLFieldTypes.text, 50),
        Field('Notes', SQLFieldTypes.text, 254),
    ...
    "StandardLithology": (
        ...
        Field('ProportionValue', SQLFieldTypes.text),
